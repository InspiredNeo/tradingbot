"""
Adaptive Backtest v2 -- Complete rewrite with all improvements
...
def run_adaptive_v2(start="2004-06-30", verbose=True):
    ...
    out = os.path.join(DATA_DIR, "adaptive_backtest_v2.json")
